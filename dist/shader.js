var b=(o,e)=>()=>(e||o((e={exports:{}}).exports,e),e.exports);import*as t from"https://esm.sh/three@0.171.0";import{EffectComposer as z}from"https://esm.sh/three@0.171.0/examples/jsm/postprocessing/EffectComposer.js";import{RenderPass as M}from"https://esm.sh/three@0.171.0/examples/jsm/postprocessing/RenderPass.js";import{ShaderPass as C}from"https://esm.sh/three@0.171.0/examples/jsm/postprocessing/ShaderPass.js";var q=b(()=>{const n=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||navigator.maxTouchPoints>1&&window.innerWidth<1025,i={waveSpeed:.015,waveFrequency:3,waveAmplitude:.4,waveColor:[35/200,35/200,35/200],colorNum:4,pixelSize:n?4:3,mouseRadius:.25,enableMouse:!n,patternPasses:n?1:2,pixelRatio:n?.5:Math.min(window.devicePixelRatio,1)},R=`
...
`,F={uniforms:{tDiffuse:{value:null},resolution:{value:new t.Vector2},colorNum:{value:i.colorNum},pixelSize:{value:i.pixelSize},introProgress:{value:0},time:{value:0}},vertexShader:`
varying vec2 vUv;
void main() {
vUv = uv;
gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`},u=document.getElementById("source"),m=new t.WebGLRenderer({canvas:u,antialias:!1,stencil:!1,depth:!1,powerPreference:"low-power"});m.setPixelRatio(i.pixelRatio);const x=new t.Scene,r=new t.PerspectiveCamera(75,1,.1,100);r.position.z=6;const s={time:{value:0},resolution:{value:new t.Vector2},invResolution:{value:new t.Vector2},waveSpeed:{value:i.waveSpeed},waveFrequency:{value:i.waveFrequency},waveAmplitude:{value:i.waveAmplitude},waveColor:{value:new t.Color(...i.waveColor)},mousePos:{value:new t.Vector2(-9999,-9999)},enableMouseInteraction:{value:i.enableMouse?1:0},mouseRadius:{value:i.mouseRadius},aspect:{value:1}},I=new t.ShaderMaterial({vertexShader:N,fragmentShader:R,uniforms:s}),A=new t.PlaneGeometry(1,1),f=new t.Mesh(A,I);x.add(f);const c=new z(m);c.addPass(new M(x,r));const v=new C(F);c.addPass(v);function w(){const o=window.innerWidth,e=window.innerHeight;m.setSize(o,e),c.setSize(o,e),r.aspect=o/e,r.updateProjectionMatrix();const a=r.position.z,l=r.fov*Math.PI/180,p=2*Math.tan(l/2)*a,S=p*r.aspect;f.scale.set(S,p,1),s.resolution.value.set(o,e),s.invResolution.value.set(1/o,1/e),s.aspect.value=o/e,v.uniforms.resolution.value.set(o,e)}window.addEventListener("resize",w),w();const g=new t.Raycaster,d=new t.Vector2,y=new t.Vector2(-9999,-9999);u.addEventListener("pointermove",o=>{if(!i.enableMouse)return;const e=u.getBoundingClientRect();d.x=(o.clientX-e.left)/e.width*2-1,d.y=-((o.clientY-e.top)/e.height)*2+1,g.setFromCamera(d,r);const a=g.intersectObject(f);if(a.length>0){const l=a[0].uv;y.set(l.x*e.width,(1-l.y)*e.height)}});let h=0;function P(o){requestAnimationFrame(P);const e=Math.min((o-h)/1e3,.1);h=o;const a=o/1e3%1e4;s.time.value=a,v.uniforms.time.value=a,v.uniforms.introProgress.value=window.CloudShaderAPI.progress,s.mousePos.value.lerp(y,1-Math.exp(-5*e)),c.render()}requestAnimationFrame(P)});export default q();
